...
public class SuperPaintProgram extends JFrame
{
    ...
    private JTextField	statusField =			// status field at the top of the window
	    				...
	    				rDecimalField = new JTextField("Decimal for red"),
	    				gDecimalField = new JTextField("Decimal for green"),
	    				bDecimalField = new JTextField("Decimal for blue");
	...
	RGBbutton.addActionListener(bh);
	...
	buttonContainer2.add(RGBbutton);
	
	JPanel RGBfieldContainer = new JPanel();
	RGBfieldContainer.add(rDecimalField);
	RGBfieldContainer.add(gDecimalField);
	RGBfieldContainer.add(bDecimalField);
	...
	masterPanel.add(buttonContainer2, BorderLayout.WEST);
	masterPanel.add(RGBfieldContainer, BorderLayout.WEST);
    ...
    {
	private Color color = Color.WHITE;	// this pixel's current color
