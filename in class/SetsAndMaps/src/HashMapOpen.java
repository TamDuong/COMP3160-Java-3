...
public class HashMapOpen<K, V> implements Map<K, V>
{
	...
	//*MC* notice putting the key infront of equals method and after is really matter bc if the index is null then it won't throw exception
		//*MC* it just like putting key == null again null == key; of course you will always pick the first 1.
